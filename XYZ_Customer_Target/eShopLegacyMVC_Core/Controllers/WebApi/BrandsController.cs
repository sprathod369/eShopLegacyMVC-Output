...
namespace eShopLegacyMVC_Core.Controllers.WebApi
{
    ...
    public class BrandsController : ControllerBase
    {
        ...
        public ActionResult<CatalogBrand> Get(int id)
        {
            ...
            var brand = _service.GetCatalogBrandsAsync().Result.FirstOrDefault(x => x.Id == id);
            if (brand == null)
            {
        ...
        public IActionResult Delete(int id)
        {
            ...
            var brandToDelete = _service.GetCatalogBrandsAsync().Result.FirstOrDefault(x => x.Id == id);
